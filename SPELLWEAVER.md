...
Every item you register gets a vertex on `Z/(2⁶)Z`: the six-bit ring. The bits encode six operational dimensions:

| Bit | Dimension | Meaning |
|-----|-----------|---------|
| b₁ | **Protection** | Concealment, privacy, zero-knowledge |
| b₂ | **Delegation** | Binding, anchoring, immutable record |
| b₃ | **Memory** | Verification, attestation, proof generation |
| b₄ | **Connection** | Linking, federation, relationship |
| b₅ | **Computation** | Recursion, self-reference, oracle |
| b₆ | **Value** | Transfer, proxy, capability issuance |

Your DID sits at vertex **1** (000001): pure Protection. A VC proving your schema sits at **7** (000111): Protection + Delegation + Memory. The lattice tells you what a thing *does* by where it *sits*.
